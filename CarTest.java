...
public class CarTest {
    ...
    public void testDecreasedPrice(String brand, String licensePlate, double price, double expectedPrice) {
        Car c1 = Car.make(brand, licensePlate, price);
        c1.decreasePrice();
        assertEquals(expectedPrice, c1.getPrice(), "Car.decreasePrice(): the method does not reduce the harvest.");
    }
    ...
    public void testCheaper() {
        ...
        assertFalse(c3.isCheaperThan(c4), "Car.cheaperThan(): the method does not return the correct data in the case of cars of the same make.");
        assertFalse(c4.isCheaperThan(c3), "Car.cheaperThan(): the method does not return the correct data in the case of cars of the same make.");
    }
